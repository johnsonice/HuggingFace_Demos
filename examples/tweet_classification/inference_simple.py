...
if __name__ == "__main__":    
    ...
    data_folder = '/data/chuang/Twitter_Data/climate_awareness'
    Inference_data_dir = os.path.join(data_folder,'climate_awareness_agg.csv')
    Inference_data_out_dir = os.path.join(data_folder,'climate_awareness_agg_senti.csv')
